...
export class FormPage {
  ...
  ionViewDidLoad() {
    this.sampleForm = this.fbld.group({
      // username: ['', Validators.compose([Validators.maxLength(25), Validators.minLength(5), Validators.pattern('^(?=.*[a-zA-Z])(?=.*[0-9])[a-zA-Z0-9]+$'), Validators.required, UsernameValidator.validUsername])],
      ...
      username: ['', Validators.compose([Validators.required, Validators.minLength(5), Validators.maxLength(25), Validators.pattern('^(?=.*[a-zA-Z])(?=.*[0-9])[a-zA-Z0-9]+$')]), UsernameValidator.validUsername],
